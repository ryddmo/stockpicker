...
/**
 * One entry of the tradable Swedish universe: an ISIN, the instrument's display
 * name (doubling as the Nordnet search string, mirroring Store\Instrument), and
 * the normalized list label.
 *
